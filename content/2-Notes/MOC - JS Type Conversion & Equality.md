...
* [[js-implicit-coercion]] - When the JS engine automatically converts types.
...
* [[js-string-valueof-and-tostring]] - Extracting the primitive string value from wrapper objects during conversions.
...
* [[js-loose-equality-comparison-rules]] - The specific algorithm JS uses when evaluating `==`.
